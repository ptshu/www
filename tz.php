...
<script language="JavaScript" type="text/javascript" src="http://libs.zzidc.com/plugin/jquery/1.7.2/jquery.min.js"></script>
...
<table>
  ...
  <tr>
    <td>打开远程文件（allow_url_fopen / fsockopen函数）：</td>
  ...
  <tr>
   ...
   <tr>
	...
	<tr style="font-size:16px;height:50px;line-height:50px">
		<td>默认支持函数（enable_functions）：</td>
		<td colspan="3">
			<a href='<?php echo $phpSelf;?>?act=Function' target='_blank' style="color:#009cd6">请点这里查看详细！</a>
		</td>		
	</tr>
	<tr>
